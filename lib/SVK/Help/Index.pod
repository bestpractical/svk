...
If you've never used SVK before, you should start by reading the B<intro>,
a getting started guide for svk. To do that, type:
...
Additional documentation is available on the web at L<http://svk.elixus.org/>.
